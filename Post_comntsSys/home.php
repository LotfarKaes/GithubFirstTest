...
<!--                                        delete the post by clicking red button in home page  -->
					<h3>Posted by: <a href="#"> <?php echo $posted_by; ?></a>
<!--                                            display posted by and below code is for display date and time -->
					-
						<?php	
                                                // use php code tag step by step and print out 
					...
					<br>
							<?php	
                                                        ...
                                                        // display  time and date when it's posted ....
					...
					<?php
							...
							<?php
								if (isset($_POST['post'])){    // post something from here!!! user post from here!!
